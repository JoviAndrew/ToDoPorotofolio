...
function statusChangeCallback(response) {
    ...
    if (response.status === 'connected') {
      ...
      .then( function(axiosResponse){
            ...
            localStorage.setItem('firstname', axiosResponse.data.firstname);
            localStorage.setItem('lastname', axiosResponse.data.lastname);
            localStorage.setItem('username', axiosResponse.data.username);
            localStorage.setItem('fb', axiosResponse.data.fb_login);
